...
// Secciones del panel del cliente (compartidas con ClientPanel).
// Solo incluye lo que le corresponde al cliente: nada de usuarios, ventas globales ni administración.
export const CLIENT_TABS = [
  ...
  { id: 'switch', label: 'Cambiar cuenta', icon: '🔄' },
]

/**
 * Sidebar del panel del cliente.
