...
// Secciones del panel del empleado (compartidas con EmployeePanel).
// El empleado gestiona el día a día operativo: ventas, facturas, reportes,
// PQR y el catálogo de productos y servicios. No tiene acceso a usuarios ni a la configuración del sistema.
...
/**
 * Sidebar del panel del empleado.
...
const EmployeeSidebar = ({
  ...
  const roleLabel = user?.rol === 'administrador' ? 'Administrador' : 'Empleado'
